//Taken from https://github.com/anthonywebb/express-pagination/blob/931360f54bd41a5192ae1b19c1a4ffd7bc4c837c/index.js
  ...
  for (n=1; n <= settings["total"]; n++) {
    ...
    if (n === settings["current"]) {
      ...
      if (settings["show_all"] || (n <= settings["end_size"] || (settings["current"] && n >= settings["current"] - settings["mid_size"] && n <= settings["current"] + settings["mid_size"]) || n > settings["total"] - settings["end_size"])) {
        ...
        // page_links.push('<li class="disabled"><a disabled="disabled" href="#">&#8230;</a></li>');
        page_links.push('<li class="disabled"><span>&#8230;</span></li>');
        dots = false;
      }
    }
  }
